...
${OBJECTDIR}/StandardGravityBehaviour.o: StandardGravityBehaviour.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/StandardGravityBehaviour.o StandardGravityBehaviour.cpp
...
${OBJECTDIR}/TimeBehaviour.o: TimeBehaviour.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/TimeBehaviour.o TimeBehaviour.cpp

${OBJECTDIR}/StandardPhysics.o: StandardPhysics.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/StandardPhysics.o StandardPhysics.cpp

${OBJECTDIR}/StandardMagnetismBehaviour.o: StandardMagnetismBehaviour.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/StandardMagnetismBehaviour.o StandardMagnetismBehaviour.cpp

${OBJECTDIR}/LevelObject.o: LevelObject.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/LevelObject.o LevelObject.cpp
...
${OBJECTDIR}/CollisionHandler.o: CollisionHandler.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/CollisionHandler.o CollisionHandler.cpp

${OBJECTDIR}/Pause.o: Pause.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/Pause.o Pause.cpp
...
${OBJECTDIR}/PhysicsApplyableObject.o: PhysicsApplyableObject.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/PhysicsApplyableObject.o PhysicsApplyableObject.cpp
...
${OBJECTDIR}/StandardTimeBehaviour.o: StandardTimeBehaviour.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/StandardTimeBehaviour.o StandardTimeBehaviour.cpp
...
${OBJECTDIR}/ForceBehaviour.o: ForceBehaviour.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/ForceBehaviour.o ForceBehaviour.cpp

${OBJECTDIR}/PlayerObject.o: PlayerObject.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/PlayerObject.o PlayerObject.cpp
